...
private:
    ...
    struct Tstrs : public std::unordered_map<ffstring, ffstring> {
    public:
        void init(Tinifile &ini);
    ...
    struct Tdialog : public std::unordered_map<int, ffstring> {
    private:
    ...
    typedef std::unordered_map<int, Tdialog> Tdialogs;
