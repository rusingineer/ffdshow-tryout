...
private:
    ...
    public:
        ...
        bool operator()(const TcspInfo* &csp1, const TcspInfo* &csp2) const;
    };
public:
...
extern uint64_t csp_bestMatch(uint64_t inCSP, uint64_t wantedCSPS, int *rank = nullptr, uint64_t outPrimaryCSP = 0);
