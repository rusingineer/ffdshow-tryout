...
#define WHITELIST_EXE_FILENAME \
    ...
    _l("JetAudio.exe;jetvideo.exe;jwBrowser.exe;kiteplayer.exe;kmplayer.exe;KwMusic.exe;LA.exe;LifeCam.exe;LifeFrame.exe;Lilith.exe;makeAVIS.exe;MatroskaDiag.exe;Maxthon.exe;MDirect.exe;media center 19.exe;Media Jukebox.exe;Media Player Classic.exe;")\
...
#define BLACKLIST_EXE_FILENAME \
    _l("age3.exe;aircamwin.exe;an.exe;autopico.exe;AvatarMP.exe;BeachSoccer.exe;boostspeed.exe;Bully.exe;civilizationv.exe;civilizationv_dx11.exe;cm2008.exe;cm2010.exe;cmr4.exe;cmr5.exe;conflictdeniedops.exe;conquer.exe;crazy_taxi_pc.exe;crystaleye.exe;daoriginslauncher.exe;dark_horizon.exe;darksiderspc.exe;data.exe;DaybreakDX.exe;DisciplesIII.exe;divinity2.exe;dmc3se.exe;dragonica.exe;dragonage2launcher.exe;drakensang.exe;drome racers.exe;em3.exe;em4.exe;empires_dmw.exe;engine.exe;eurotrucks2.exe;evochronmercenary.exe;explorer.exe;fable.exe;Edition.exe;FalconAF.exe;fallout3.exe;falloutnv.4gb;falloutnv.exe;ff7.exe;ffxiv.exe;fordorr.exe;fr2.exe;fr3.exe;freedom.exe;fsr.exe;game.bin;game.exe;googletalkplugin.exe;gorky17.exe;Grandia2.exe;gta-vc.exe;gta3.exe;gta_sa.exe;")\
