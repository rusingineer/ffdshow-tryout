...
CDXVADecoderH264::CDXVADecoderH264(CMPCDXVAVideoDecFilter* pFilter, IAMVideoAccelerator*  pAMVideoAccelerator, DXVAMode nMode, int nPicEntryNumber)
...
CDXVADecoderH264::CDXVADecoderH264(CMPCDXVAVideoDecFilter* pFilter, IDirectXVideoDecoder* pDirectXVideoDec, DXVAMode nMode, int nPicEntryNumber, DXVA2_ConfigPictureDecode* pDXVA2Config)
