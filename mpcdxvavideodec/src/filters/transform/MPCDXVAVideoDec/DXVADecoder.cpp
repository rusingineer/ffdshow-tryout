...
CDXVADecoder::CDXVADecoder(CMPCDXVAVideoDecFilter* pFilter,
...
void CDXVADecoder::Init(CMPCDXVAVideoDecFilter* pFilter, DXVAMode nMode, int nPicEntryNumber)
{
    m_pFilter           = pFilter;
    m_nMode             = nMode;
...
CDXVADecoder* CDXVADecoder::CreateDecoder(CMPCDXVAVideoDecFilter* pFilter, IAMVideoAccelerator* pAMVideoAccelerator, const GUID* guidDecoder, int nPicEntryNumber)
{
...
CDXVADecoder* CDXVADecoder::CreateDecoder(CMPCDXVAVideoDecFilter* pFilter, IDirectXVideoDecoder* pDirectXVideoDec, const GUID* guidDecoder, int nPicEntryNumber, DXVA2_ConfigPictureDecode* pDXVA2Config)
{
    CDXVADecoder* pDecoder = nullptr;
