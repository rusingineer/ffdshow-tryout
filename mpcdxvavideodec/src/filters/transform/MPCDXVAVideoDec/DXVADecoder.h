...
public:
    ...
    static CDXVADecoder* CreateDecoder(CMPCDXVAVideoDecFilter* pFilter,
...
protected:
    CDXVADecoder(CMPCDXVAVideoDecFilter* pFilter, IAMVideoAccelerator*  pAMVideoAccelerator, DXVAMode nMode, int nPicEntryNumber);
    CDXVADecoder(CMPCDXVAVideoDecFilter* pFilter, IDirectXVideoDecoder* pDirectXVideoDec, DXVAMode nMode, int nPicEntryNumber, DXVA2_ConfigPictureDecode* pDXVA2Config);

    CMPCDXVAVideoDecFilter* m_pFilter;
    bool m_bFlushed;
    int m_nMaxWaiting;
...
private:
    ...
    void Init(CMPCDXVAVideoDecFilter* pFilter, DXVAMode nMode, int nPicEntryNumber);
