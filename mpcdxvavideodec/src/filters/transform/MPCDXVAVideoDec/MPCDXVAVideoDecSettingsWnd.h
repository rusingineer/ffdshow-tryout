...
class __declspec(uuid("D5AA0389-D274-48e1-BF50-ACB05A56DDE0"))
    CMPCDXVAVideoDecSettingsWnd : public CInternalPropertyPageWnd
{
    CComQIPtr<IMPCDXVAVideoDecFilter2> m_pMDF;
...
class __declspec(uuid("3C395D46-8B0F-440d-B962-2F4A97355453"))
    CMPCDXVAVideoDecCodecWnd : public CInternalPropertyPageWnd
{
    CComQIPtr<IMPCDXVAVideoDecFilter> m_pMDF;
